                    ...
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li>
                            <a href="{{ route('nosotros') }}"
                                class="{{ request()->routeIs('nosotros') ? ' text-white rounded bg-green-700 lg:bg-transparent lg:text-green-700 lg:p-0  lg:text-green-700 lg:p-0 ' : ' text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-green-700 lg:p-0  ' }} block py-2 pr-4 pl-3 rounded ">
                                Nosotros
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('productos') }}"
                                class="{{ request()->routeIs('productos') ? ' text-white rounded bg-green-700 lg:bg-transparent lg:text-green-700 lg:p-0  lg:text-green-700 lg:p-0 ' : ' text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-green-700 lg:p-0  ' }} block py-2 pr-4 pl-3 rounded ">
                                Productos
                            </a>
                        </li>
                        <li>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="sm:flex sm:flex-wrap sm:-mx-4 mt-6 pt-6 sm:mt-12 sm:pt-12 border-t">
                ...
                <div class="px-4 md:w-1/4 md:ml-auto mt-6 sm:mt-4 md:mt-0">
                    <button
                        class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Contactarnos</button>
                </div>
            </div>
        </div>
    </footer>
