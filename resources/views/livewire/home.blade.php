<div>
        ...
        <section class="w-full bg-cover bg-center py-48"
            ...
            <div class="container mx-auto text-center text-white">
                ...
                <a href="{{ route('contacto') }}"
                    class="hidden lg:inline-block text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Contáctenos</a>

            </div>
        </section>

    </div>
    <div class="px-full px-4 sm:px-6 lg:px-8 pt-24 ">
    ...
    <div class="w-3/4 mx-auto  px-4 sm:px-6 lg:px-8 my-24">


        <p class=" 
            mx-auto mt-5  text-center text-lg leading-relaxed text-slate-700 sm:mt-6">
            En Viul, nos dedicamos a ofrecer las mejores soluciones en membranas para techos y pinturas. Con un
            fuerte compromiso con la calidad y los precios más competitivos del mercado, nos destacamos como líderes
            en el sector. Nuestro equipo de profesionales está listo para asesorarte y brindarte productos que
            garantizan la durabilidad y protección de tu hogar o negocio. Con años de experiencia, somos tu mejor
            opción para mantener tus techos en perfectas condiciones.
        </p>

    </div>
    <div class="flex flex-col items-center justify-center  pb-12">
        <div>
            <h2 class=" text-5xl text-slate-700 font-semibold">Productos</h2>
            <div>
